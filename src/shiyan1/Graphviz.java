...
public class Graphviz{
    ...
    public Graphviz() {
        if (Graphviz.osName.contains("Windows")) {
            this.tempDir = "D:/lab1test";
            this.executable = "D:/Program Files (x86)/Graphviz/bin/dot.exe";
...
//dot D:\lab1test\graph2.gv -Tpng -o image.png
        //dot -Tpng -o test.png D:/lab1test/graph1.gv  
        try
        {
